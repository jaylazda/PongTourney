...
//  PongUITests
//
//  Created by Jacob Lazda on 2020-06-29.
...
class PongUITests: XCTestCase {
    ...
    func testExample() throws {
        ...
        let loginStaticText = app/*@START_MENU_TOKEN@*/.staticTexts["LOGIN"]/*[[".buttons[\"LOGIN\"].staticTexts[\"LOGIN\"]",".staticTexts[\"LOGIN\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        loginStaticText.tap()
